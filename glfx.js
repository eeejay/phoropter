...
var Shader = (function() {
    function isArray(obj) {
        return Array.isArray(obj) || obj.constructor == Float32Array;
    }
...
exports.canvas = function() {
    ...
    canvas.colorMatrix = wrap(colorMatrix);
...
// src/filters/adjust/colormatrix.js
/**
 * @filter           Brightness / Contrast
 * @description      Provides additive brightness and multiplicative contrast control.
 * @param brightness -1 to 1 (-1 is solid black, 0 is no change, and 1 is solid white)
...
function colorMatrix(matrix) {
  var m = new Float32Array(matrix);
    ...
    var shaderName = (1==m[18]&&0==m[3]&&0==m[8]&&0==m[13]&&0==m[15]&&0==m[16]&&0==m[17]&&0==m[19])
			? 'colorMatrix' : 'colorMatrixAlpha';

    gl[shaderName] = gl[shaderName] || new Shader(null, kShaderCode[shaderName]);

    simpleShader.call(this, gl[shaderName], { m });
